...
public class SettingMazda6 extends JPanel {
	...
	public SettingMazda6() {
		
		setLayout(new MigLayout("", "[85.00px][86.00][100.00px,grow]", "[][][][20.00][20.00][40.00][]"));

		final JLabel label = new JLabel("Замена масла каждые ");
		...
		btnOilOld.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					MazdaDB.getInstance().inDB("Mazda6_oil", "change", oilOld);
		...
		JLabel label_2 = new JLabel("Замена ремня каждые ");
		...
		btnBeltOld.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					MazdaDB.getInstance().inDB("Mazda6_belt", "change", beltOld);
		...
		JLabel label_1 = new JLabel("Замена колодок каждые ");
		...
		btnBreaksOld.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					MazdaDB.getInstance().inDB("Mazda6_breaks", "change", oilOld);
